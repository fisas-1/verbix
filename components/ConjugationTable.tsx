...
export default function ConjugationTable({ tenses, infinitive: _infinitive, lang = "es" }: ConjugationTableProps) {
    ...
    <section className="w-full">
      ...
      <div className="space-y-8">
        {filteredTenses.map((tenseData) => {
          const tenseLabel = tr.tenseLabels[tenseData.tense] ?? tenseData.label;
          return (
            <div key={tenseData.tense}>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">
                {tr.conjugationIn} {tenseLabel}
              </h2>
