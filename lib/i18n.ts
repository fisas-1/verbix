...
const es: LangStrings = {
  ...
  verbTitleTemplate: (v) => `Conjugar ${v} - Todos los tiempos verbales | Verblop`,
  verbDescTemplate: (v) =>
    `Conjugación completa de ${v}: presente, pasado, futuro y subjuntivo. Con ejemplos reales y ejercicios. ¡Aprende a conjugar ${v} ahora!`,
  verbKeywords: (v) => [`conjugar ${v}`, `conjugación de ${v}`, `${v} conjugado`, `${v} en presente`, `${v} en pasado`, `pretérito de ${v}`],
...
const ca: LangStrings = {
  ...
  verbTitleTemplate: (v) => `Conjugar ${v} en espanyol - Tots els temps | Verblop`,
  verbDescTemplate: (v) =>
    `Conjugació completa de ${v}: present, passat, futur i subjuntiu. Amb exemples reals i exercicis. Aprèn a conjugar ${v} ara!`,
  verbKeywords: (v) => [`conjugar ${v}`, `conjugació de ${v}`, `${v} conjugat`, `${v} en present`, `pretèrit de ${v}`],
...
const en: LangStrings = {
  ...
  verbTitleTemplate: (v) => `Conjugate ${v} in Spanish - All Tenses | Verblop`,
  verbDescTemplate: (v) =>
    `Complete conjugation of ${v} in Spanish: present, past, future and subjunctive. Real examples and exercises. Learn to conjugate ${v} now!`,
  verbKeywords: (v) => [`conjugate ${v}`, `${v} conjugation`, `how to conjugate ${v}`, `${v} present tense`, `${v} past tense Spanish`],
